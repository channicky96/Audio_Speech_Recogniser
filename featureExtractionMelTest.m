...
%     temp = floor(((windowSize/1000)*fs)*(1-overlap));
%     
%     temp = temp/length(y);
%     temp = floor((1/temp - 1))-1
%     pause;
%     
%     
...
%             for e = 1:(length(x)*(1-truncationLevel))
%                 totalEnergy = totalEnergy + (x(e)^2);
%             end
%             totalEnergy = sum(x.^2);
%             totalEnergy = log10(totalEnergy);
%             energies(winNumber) = totalEnergy;
% 
